    ...
    */
            ...
            <table id="survey_dashboard_table">
                ...
                {this.state.surveys.map(survey => 
                    <tr key={survey.surveyId}>
                        ...
                        <td>{survey.status === "active" ? <button id={"link-button-"+survey.surveyId} className="nav_button" onClick={this.onClickHandler}>Get Link</button> : survey.status === "created" ? <button id={"publish-button-"+survey.surveyId} className="nav_button" onClick={this.onClickHandler}>Publish</button> : null} </td>
                        <td>{survey.status !== "closed" ? <Link to={"/editform/"+survey.surveyId}><button id={"view-button-"+survey.surveyId} className="nav_button">Edit</button></Link> : null}</td>
                        <td>{survey.status !== "created" ? <Link to={"/reporting/"+survey.surveyId}><button id={"report-button-"+survey.surveyId} className="nav_button" onClick={this.onClickHandler}>Results</button></Link> : null}</td>
                        <td><button id={"delete-button-"+survey.surveyId} className="nav_button" onClick={this.onClickHandler}>Delete</button></td>
    ...
    render() {
        if(this.state.error){
            ...
            let publishButton = this.state.option === "publish" ? <button className="nav_button" onClick={this.publishSurvey}>Publish</button> : null;
            ...
            return (
                <div id="link-page">
                    ...
                    <div>
                        ...
                        <button className="nav_button" onClick={this.copyLink}>Copy Link</button>
                    </div>
                    {publishButton}
                    <br/>
                    <button className="nav_button" onClick={event => this.setState({ survey: null, option: null })}>Ok</button>
                </div>
            );
        }
        else{
